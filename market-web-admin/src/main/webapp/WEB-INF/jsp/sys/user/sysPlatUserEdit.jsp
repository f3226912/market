...
<div class="form-page validate-error" style="padding-top:10px;">
	<form id="form-editComUser" action="post/addPost" class="form-horizontal cmxform clearfix">
		<div class="row">
		...
		<div class="form-group col-lg-5">
			...
			<div class="col-md-6 text-left">
				<select name="groupId" class="form-control" id="groupId" required class="form-control wid150">
				</select>
			</div>
		</div>
		<div class="form-group col-lg-5">
		...
		<div class="form-group col-sm-10 text-center mtop30 sys-btn-style">
			...
			<button class="btn btn-danger ml15" id="editForm" type="button" data-dismiss="modal">确认</button>
		</div>
	</form>
