    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource = new DataSourceTree({
                data: [
                    { name: '总裁办', type: 'folder', additionalParameters: { id: 'F1' } },
                    { name: '武汉白沙洲市场', type: 'folder', additionalParameters: { id: 'F2' } },
                    { name: '招商部', type: 'item', additionalParameters: { id: 'I1' } },
                    { name: '财务部', type: 'item', additionalParameters: { id: 'I2' } }
                ],
                delay: 400
            });
            ...
            var treeDataSource4 = new DataSourceTree({
                data: [
                    { name: '总裁办<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: '宏进农副产品公司<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: '<i class="fa fa-user"></i>武汉白沙洲市场<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div><div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
                    { name: '<i class="fa fa-calendar"></i>招商部<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'item', additionalParameters: { id: 'I12' } },
                    { name: '<i class="fa  fa-gear "></i>财务部<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'item', additionalParameters: { id: 'I12' } }
                ],
                delay: 400
            });
