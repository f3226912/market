...
$.extend(true,snakerflow.config.props.props,{
	//=== 流程的名称不在设计图中来设定。  by wjguo 2016.10.25===
...
$.extend(true,snakerflow.config.tools.states,{
			start : {
				...
				props : {
					name: {name:'name',label: '标识', value:'start', editor: function(){return new snakerflow.editors.inputEditor();}},
				...
				attr : {width:50 ,heigth:50 },
				props : {
					name: {name:'name',label: '标识', value:'end', editor: function(){return new snakerflow.editors.inputEditor();}},
				    preInterceptors: {name:'preInterceptors', label : '前置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					postInterceptors: {name:'postInterceptors', label : '后置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}}
				}},
			task : {
				...
				props : {
					name: {name:'name',label: '标识', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					...
					assignee: {name:'assignee', label: '审批者岗位', value:'', editor: function(){return new snakerflow.editors.popSelectPostWinEditor();}},
					...
					performType: {name:'performType', label : '参与类型', value:'', editor: function(){return new snakerflow.editors.selectEditor([{name:'审批',value:'ANY'},{name:'会签',value:'ALL'}]);}},
				    preInterceptors: {name:'preInterceptors', label : '前置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
					postInterceptors: {name:'postInterceptors', label : '后置拦截器', value:'', editor: function(){return new snakerflow.editors.inputEditor();}},
