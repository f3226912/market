...
@Entity(name = "gauge_charge_record")
public class GaugeChargeRecordEntity  implements java.io.Serializable{
    /**
     *
     */
    private Long id;
    ...
    @Column(name = "gaugeNo")
    public Integer getGaugeNo(){

        return this.gaugeNo;
    }
    public void setGaugeNo(Integer gaugeNo){
