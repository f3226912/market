    ...
    <div class="contPerson clearfloat">
       ...
       <div class="cot_rit">
        ...
        <div class="resetPerson_rt">
            <h3 class="treetitB">岗位列表</h3>
          <ul id="treeDemos" class="ztree_list">

          </ul>
        </div>
        <div class="user_selected clearfloat">
            <h3 class="user_sz">已选择岗位</h3>
            <div class="user_area"></div>
        </div>
        <div class="btn_bt">
            <button id="selectPostWinCancelBtn" class="btn_cancel">取消</button>
            <button id="selectPostWinSavelBtn" class="btn_determine">保存</button>
        </div>
       </div>
    </div>
</div>  
...
<script src="${CONTEXT}/lib/snaker/js/selectPostWin.js" type="text/javascript"></script>
