...
<%@ include file="/WEB-INF/jsp/pub/tags.inc" %>
       <div class="col-md-max">
          <div class="main-search">
               <div class="main-contracht-tp details-of-contract">收款管理-应收退款详情</div>
        ...
        <div class="col-md-12 save-box">
        	<ul>
        		<li class="print-3"><a class="print-s" href="javascript:void(0)" id="saveBForm"><i class="fa fa-print"></i>&nbsp;&nbsp;打印</a></li>
        	</ul>
        </div>
        </div>
