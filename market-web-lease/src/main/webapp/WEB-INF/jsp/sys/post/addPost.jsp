...
<section class="header">新增岗位</section>
...
<div class="">
	<form id="form-addPost" class="form-horizontal clearfix">
		<div class="tab-content validate-error">
			<div id="postInfo" class="tab-pane active">
				<div class="form-group col-lg-12 ">
					...
					<div class="input-group col-sm-6" style="margin-bottom:15px;">
						<input id="orgId" name="orgId" type="hidden" class="form-control">
						<input class="form-control" type="text" id="orgName" name="orgName" readonly="readonly" placeholder="从部门树选择部门" style="width:243px; border-radius:2px;"/>
						<div class="input-group-btn" style="position:absolute; top:0; left:243px;">
							<button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
							<div class="dropdown-menu pull-right" style="right:-26px;">
				...
				<div class="form-group col-lg-12">
					...
					<div class="col-md-6 text-left">
						<input name="name" type="text" class="form-control" maxlength="20" style="width:270px; position: relative; right:15px;" autocomplete="off">
					</div>
				</div>
				<div class="form-group col-lg-12" style="margin-top:15px;">
					<label class="control-label col-md-4">岗位说明：</label>
					<div class="col-sm-6 text-left">
						<textarea name="remark" class="form-control" rows="5" cols="150" style="position: relative; right: 14px;" maxlength="200" autocomplete="off"></textarea>
					</div>
				</div>
			</div>
		...
		<div class="form-group col-lg-10 text-center mtop30" style="margin-left:30px;">
			...
			<gd:btn btncode="BtnSysPostAddSave"><button class="btn btn-danger ml15" id="saveForm" type="submit" data-dismiss="modal" style="width:120px; height:40px; font-size:20px;">保存</button></gd:btn>
		</div>
	</form>
</div>
</div>
