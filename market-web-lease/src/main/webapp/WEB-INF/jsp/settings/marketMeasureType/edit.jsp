    ...
    <div class="col-sm-12">
        <section class="panel">
            <div class="contract-title-block">
                <span class="contract-info-h3">&nbsp;&nbsp;&nbsp;计量表分类详情&nbsp;&nbsp;&nbsp;</span>
            </div>
	            ...
	            <div class="text-center overflow-h magin-auto padding-t-b-35 w-40 efrom">
	           		<ul class="overflow-h">
	           			<li>
	           				...
	           				<div class="fl w-60"><input type="text" value="" name="code" id="code"/></div>
	           			</li>
	           			<li>
	           				<div class="fl w-35"><i class="payment-cycle-sp">*</i>计量表分类名称:</div>
	           				<div class="fl w-60"><input type="text" value="" id="name" name="name"/></div>
	           			</li>
	           			<li>
           			...
           			<gd:btn btncode="BtnMeasureTypeEditSave">
