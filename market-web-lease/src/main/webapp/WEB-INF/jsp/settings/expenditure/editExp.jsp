		...
		<div class="col-sm-12">
	        <section class="panel">
				...
				<div class="contract-title-block">
	                <span class="contract-info-h3">&nbsp;&nbsp;&nbsp;&nbsp;修改费项&nbsp;&nbsp;&nbsp;&nbsp;</span>
	            </div>
				<!-- 表单 -->
					...
					<div class="text-center overflow-h magin-auto padding-t-b-35 w-40 efrom">
		           		...
		           		<ul class="overflow-h">
		           			...
		           			<li>
		           				...
		           				<div class="fl w-60"><input type="text" name="expTypeName" readonly="readonly"/></div>
		           			</li>
		           			<li>
		           				<div class="fl w-35"><i class="payment-cycle-sp">&nbsp;</i>费项说明:</div>
		           				<div class="fl w-60"><textarea style="padding:5px 10px" name="expDetail" id="expDetail"></textarea></div>
		           			</li>
		           		</ul>
		           		
		           		<!-- 按钮块，操作表单 -->
		           		<button type="button" class="btn btn-ash btn-big" onclick="javascript:window.location='index#expenditure'">取消</button>
		           		<gd:btn btncode="BtnExpEditSave"><button type="submit" id="saveForm" class="btn btn-danger btn-big" >保存</button></gd:btn>
	           		</div>
				</form>
			</section>
		</div>
