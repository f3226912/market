		...
		<div class="col-sm-12">
			<section class="panel">
				<div class="contract-title-block">
					<span class="contract-info-h3">&nbsp;&nbsp;&nbsp;&nbsp;修改计费标准&nbsp;&nbsp;&nbsp;&nbsp;</span>
				</div>
				<form id="form-edit" action="" class="form-horizontal clearfix">
					<div class="text-center overflow-h magin-auto padding-t-b-35 w-84 efrom">
						<ul id="wrap" class="overflow-h">
				           ...
				           <li id="sectionalChargeLi">
								<div class="fl w-35 text-left"><i class="payment-cycle-sp">*</i>是否分段计费:</div>
								<label for="radio-1-1"><input type="radio"  id="radio-1-1"  name="sectionalCharge"  value="1" class="regular-radio" >
								    <span class="radio-mt10"></span><em class="radio-em" >是</em>
								</label>
							    <label for="radio-1-2"><input type="radio" id="radio-1-2""  name="sectionalCharge"  value="0" class="regular-radio">
							...
							<div class="etable">
								...
								<ul>
									<li id="deleteChargeSection"><i class="fa fa-trash-o"></i>
										<gd:btn btncode="BtnEditSecChargeDelete"><a style="cursor:pointer;">删除</a></gd:btn>
									</li>
									<li id="addChargeSection"><i class="fa fa-list"></i>
										<gd:btn btncode="BtnEditSecChargeAdd"><a style="cursor:pointer;">新增</a></gd:btn>
									</li>
								</ul>
							</div>
							<table>
						...
						<gd:btn btncode="BtnExpStandardEditSave"><button type="submit" class="btn btn-danger btn-big" id="save">保存</button></gd:btn>
					</div>
				</form>
			</section>
		</div>
