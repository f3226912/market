...
#contractFile2-queue{opacity:1!important; filter:Alpha(opacity=1)!important;}
...
#uploadDiv{border:1px solid #ccc; padding-top:3px; margin-top:-15px; width:877px; height:120px}
       ...
       <div class="col-md-max contract">
		...
		<form action="" id="mainDto_form" novalidate>
                 ...
                 <div class="contract-info">
                 	...
                 	<div class="change-details" style="padding-bottom:0;">
                 		...
                 		<div class="terms-file" style="position:relative; top:-30px;">
                 		  ...
                 		  <p class="additional-terms"><span class="terms_no">合同附件</span><input id="contractFile2" runat="server" type="file" /></p>
                 		  <div id="uploadDiv">
