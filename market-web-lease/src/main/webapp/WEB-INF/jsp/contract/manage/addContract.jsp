...
.ipt_m{ position:absolute; top:0; float:left; right: 15px; font-style:normal}
      ...
      <form action="" novalidate id="mainDto_form">
       <div class="col-md-max contract">
          ...
          <div class="col-md-12 col-pd-13">
               <div class="contract-info">
               	 ...
               	 <div class="col-md-12 fees-box-zp" style="position:relative; height: 40px;line-height: 40px;"> 
               		   ...
               		   <div style="position:absolute; top:0px; right:68px; color: green; font-weight: bold;">选择</div>
               	      </div>
               	 </div>
               ...
               <div class="contract-info">
				...
				<span class="radio-mt10"></span><em class="radio-em-fees">套内面积</em></label>	
					  ...
					  <!-- <tr class="charges-tab-blank">
					    ...
					    <td class="area">0</td>
					    <td class="totalM clearRental"><input value="0" type="hidden" name="rental" readonly="readonly" style="width:100px"></td>							    
					  </tr> -->
					  ...
					  <!-- <tr class="charges-tab-blank">
					    ...
					    <td><input class="rents" type="hidden" type="text" name="freeEndDay"/></td>
					  </tr> -->
					  </tbody>
                	 	</table>
               	    </div>
               ...
               <div class="amount-ipt2">
               	...
               	<div class="total_amount">
               	     <div class="rents_agreement clearfloat">
               	     	<p class="rents_agreement_p" style="padding-left: 73px; padding-top: 8px; float: left;">缴费约定</p>
               		...
               		<table id="econManageDT" class="charges-tab-style" cellspacing="0" style="margin-bottom:30px;">
         	 		 <tr class="charges-tab-bg">
					    <td class="charges-tab-bor">序号</td>
					    <td>缴费期限</td>
					    <td>缴费金额</td>
        ...
        <div class="col-md-12 save-box">
        	<ul style="padding-left: 250px;">
        		...
        		<!-- <li class="approval-2"><span class="approval-s">人工审批</span></li>
        		<li class="approval-2" id="workflow_btn"><span class="approval-s">工作流审批</span></li> 
...
<!--选择租赁资源-->
<div id="leasResources" style="display:none;">
