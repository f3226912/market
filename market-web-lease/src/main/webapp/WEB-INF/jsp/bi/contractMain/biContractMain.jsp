...
<div class="col-md-max">
  <div class="main-search">
       <div class="main-contracht-tp">
       	       <span class="motion-of-contract">未过期合同</span>
				<div class="input-group m-bot15">
					<div class="input-group-btn">
					</div>
					<div class="export-s" id="exportData"><gd:btn btncode="BtnBiContractMainExportData"><a class="fa fa-download" >导出</a></gd:btn> </div>
			</div>
           ...
           <div class="main-ipt-types" style="display:block;">
				...
				<div class="form-group">
					...
					<div class="form-group">
						<gd:btn btncode="BtnBiContractMainQuery"><button class="btn btn-danger" type="button" id="query" >搜索</button>
					</gd:btn>
					</div>
				</form>
               </div>
