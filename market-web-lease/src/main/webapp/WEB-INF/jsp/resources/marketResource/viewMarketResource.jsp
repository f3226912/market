...
<section class="header">基本信息</section>
<div class="form-page ditail-resoure-page">
	<section id="marketResource" class="panel">
		<header class="">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#home">基本资料</a></li>
				<li name="marketResourceBtn" class=""><a data-toggle="tab"
					href="#about">租赁单</a></li>
			</ul>
		</header>
					...
					<div class="form-page mtop15">
						<form id="form-setResource" method="post" novalidate
							...
							<div class="contract-info clearfix">
								...
								<div class="row">
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="code" type="text" placeholder="100个字符" required
												class="form-control">
										</div>
									</div>
									<div class="form-group col-lg-5 col-lg-offset-1">
								...
								<div class="row">
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="name" type="text" placeholder="100个字符" required
												class="form-control">
										</div>
									</div>
									<div class="form-group col-lg-5 col-lg-offset-1">
										...
										<div class="col-md-7 text-left">
											<input name=buildingUnitName type="text"
												placeholder="1-10个字符" maxlength="10" required
												class="form-control" />
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="form-group col-lg-5 col-lg-offset-1">
										...
										<div class="col-md-7 text-left">
											<input name="unitFloorName" type="text" placeholder="1-10个字符"
								...
								<div class="row">
									<div class="form-group col-lg-5">
										<label class="control-label col-md-5">资源类型： </label>
										<div class="col-md-7 text-left">
											<input type="text" readonly class="form-control" value="商铺">
							...
							<div class="modal-footer form-group mtop30" style="clear: left;">
								...
								<gd:btn btncode="BtnMarketResourceMarketSave">
	...
	<section id="carResource" class="panel">
		<header class="">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#home">基本资料</a></li>
				<li name="marketResourceBtn" class=""><a data-toggle="tab"
		...
		<div class="panel-body">
			<div class="tab-content">
				<div id="home" class="tab-pane active">
					<div class="form-page mtop15">
						<form id="form-setCarResource" method="post" novalidate
							class="form-horizontal clearfix cmxform">
							<input type="hidden" name="id" value="" />
							<div class="contract-info clearfix">
								<div class="contract-title-block">
								...
								<div class="row">
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="code" type="text" placeholder="100个字符" required maxlength="100"
												class="form-control">
										</div>
									</div>
									...
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="shortCode" type="text" placeholder="100个字符"  maxlength="100"
												required class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="name" type="text" placeholder="100个字符" required maxlength="100"
												class="form-control">
										</div>
									</div>
								...
								<div class="row">
									<div class="form-group col-lg-5">
										...
										<div class="col-md-7 text-left">
											<input name="unitFloorName" type="text" placeholder="1-10个字符" required
								...
								<div class="row">
									<div class="form-group col-lg-5">
										<label class="control-label col-md-5">资源类型： </label>
										<div class="col-md-7 text-left">
											<input type="text" readonly class="form-control" value="停车位">
											<input name="parentId" type="hidden" value="2">
										</div>
									</div>
									<div class="form-group col-lg-5">
										<label class="control-label col-md-5"> <i
							...
							<div id="measurediv" class="form-group contract-info"
								style="display: none;">
							...
							<div class="modal-footer form-group mtop30" style="clear: left;">
								<input type="button" id="btn_cancel" class="btn btn-default"
									id="btn_cancel" value="取消" />
								<gd:btn btncode="BtnMarketResourceCarSave">
									<input type="submit" class="btn btn-danger" value="保存"
										id="saveResource" />
								</gd:btn>
							</div>
