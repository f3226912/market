function _call(templateUrl,param){
   ...
   var PAGE_SIZE = 10;
						...
						function() {
						   var queryParams = selectTypeData();
							...
							var paramList = "leasingResource="+queryParams.leasingResource
							                ...
							                +"&changeReasion="+queryParams.changeReasion
							...
							disableExport = true;
							$.ajax({
										url : CONTEXT + 'contractChange/checkExportParams',
										data : queryParams,
										type : 'post',
	...
	function loadData(page, isInit){
		$.ajax({
			url:CONTEXT+"contractChange/queryPage",
			data:page,
			type: "POST",
			dataType:'json',
			success:function(data){
		...
		function selectTypeData(){
			...
			if(searchBol==0){
			 ...
			 approvalStatus=$("#ContractChange_approvalStatus").val();
			 changeReasion=$("#ContractChange_changeReasion").val();
			 
			 createTimeStart=$("#ContractChange_createTimeStart").val();
			 createTimeEnd=$("#ContractChange_createTimeEnd").val();
