...
//				$("#saveForm").click(function(){
			function saveData() {
					...
					$.ajax({
						type: "POST",
						dataType: "json",
						url: CONTEXT+"marketResourceType/add",
						data: $('#form-addMarketResourceType').serialize(),
...
//				});
				...
				function validateForm(){
					$("#form-addMarketResourceType").validate({  
					    rules:{  
					    	code:{  
					            required:true,
					            maxlength:50,
				...
				jQuery.validator.addMethod("checkCode", function(value, element) {
				    ...
				    $.ajax({
				    	type : "post",
				    	url: CONTEXT+"marketResourceType/findAllCountByCondition",
